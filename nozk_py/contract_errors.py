"""
Nozk Protocol: Contract Error Decoder

Decodes NozkVault custom error selectors (4-byte EVM revert data) into
...
The selector table is built from nozk_vault_abi.json at import time.
