"""
Nozk Protocol: Mint Server

Stateless daemon that listens for NozkVault DepositLocked events, performs
...
app = typer.Typer(
    name="mint-server",
    help="Nozk Protocol Mint Server — listens for deposits and issues blind signatures.",
